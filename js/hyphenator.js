...
var Hyphenator = (function (window) {
	...
	toggleBox = function () {
		...
		if (!!(myBox = contextWindow.document.getElementById('HyphenatorToggleBox'))) {
			...
			myBox.style.backgroundColor = '#000';
			myBox.style.color = '#FFFFFF';
			myBox.style.font = '10px Georgia';
			myBox.style.letterSpacing = '1px';
			myBox.style.padding = '3px 10px';
			myBox.style.cursor = 'pointer';
			myBox.style.WebkitBorderRadius = '5px';
			myBox.style.MozBorderRadius = '5px';
